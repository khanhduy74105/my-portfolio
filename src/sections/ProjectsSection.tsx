    ...
    <div ref={ref} className='bg-black dark:bg-white p-12 flex flex-col gap-20'>
      <div className="px-10 flex justify-around items-center border-b-2 pb-4 border-white">
        ...
        <Tilt className="w-3/5 h-[500px] relative">
          ...
          <a className="absolute bottom-4 -translate-x-1/2 left-1/2 px-3 py-1 text-lg cursor-pointer hover:opacity-70 rounded-lg bg-white text-black dark:text-white dark:bg-black">View source in Github </a>
        </Tilt>
      </div>
      <div className="px-10 flex justify-around items-center border-b-2 pb-4 border-[#aa6dd7]">
        ...
        <Tilt className="w-3/5 h-[500px] relative">
          ...
          <a className="absolute bottom-4 -translate-x-1/2 left-1/2 px-3 py-1 text-lg cursor-pointer hover:opacity-70 rounded-lg bg-[#aa6dd7]">View source in Github </a>
        </Tilt>
      </div>
      <div className="px-10 flex justify-around items-center border-b-2 pb-4 border-[#FE615D]">
        ...
        <Tilt className="w-3/5 h-[500px] relative">
          ...
          <a className="absolute bottom-4 -translate-x-1/2 left-1/2 px-3 py-1 text-lg cursor-pointer hover:opacity-70 rounded-lg bg-[#fdb664]">View source in Github </a>
        </Tilt>
      </div>
      <div className="px-10 flex justify-around items-center border-b-2 pb-4 border-[#FE615D]">
        <div className="select-none">
          ...
          <div className="mt-6">
            <h1 className='text-2xl'>Tech stacks:</h1>
            <h3 className='text-xl mt-1 px-2 flex items-center gap-3 text-[#ffffff]'><TbBrandNextjs style={{ backgroundColor: 'black' }} /> NextJs</h3>
            <h3 className='text-xl mt-1 px-2 flex items-center gap-3 text-[#3bc1a2]'><SiTailwindcss style={{ backgroundColor: '#3bc1a2' }} /> Tailwind</h3>
        ...
        <Tilt className="w-3/5 h-[500px] relative">
          ...
          <a className="absolute bottom-4 -translate-x-1/2 left-1/2 px-3 py-1 text-lg cursor-pointer hover:opacity-70 rounded-lg bg-[#FE615D]">View source in Github </a>
        </Tilt>
      </div>
      <a className="flex items-center justify-center">
        <div className="px-4 py-2 gap-2 rounded-lg dark:bg-white flex items-center justify-center">
          <span className="w-fit  text-xl hover:opacity-70">View more in my Github </span>
          <FiGithub size={40} />
        </div>
      </a>
    </div>
